...
ESP32 with a built in 320 x 240 2.8" LCD display with a ESP32 called the "ESP32-2432S028", We can name it "Cheap Yellow Display" or CYD for short.
...
- Without Touch Screen (Resistive)
...
Simple example to start using the CYD
